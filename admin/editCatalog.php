...
<center>
<h1>Edit <?php echo $catalog_row["product_name"]." - ".$catalog_row["design_description"]." - ".$catalog_row["reference_code"];?></h1>
<form action="listCatalog.php?updateCatalog" method="post" name="catalog_edit">
<input type="text" style="visibility:hidden" name="id_catalog" id="id_catalog" value="<?php echo $catalog_id;?>">
<table>
